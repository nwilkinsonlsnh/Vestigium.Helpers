...
Unchanged from v1.2 except §2.4, §28, §29, and decisions 11 / 11b / 32–35.
...
Window shape today is `EchoWindow(LocalTime, Count)`. Duration-per-window is a later addendum.
...
v1.2 surface plus §5.1–5.3. Count default 4. Grace 15 min. `MaxList` default 1024. Continuous default duration 60 s. Long continuous interval floor 1 s.
