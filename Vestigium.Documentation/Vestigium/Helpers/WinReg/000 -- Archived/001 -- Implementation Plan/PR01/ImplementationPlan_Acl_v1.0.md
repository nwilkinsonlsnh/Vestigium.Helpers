...
| Phase | Covers | Status |
|---|---|---|
| **A0 Paper** | SRS + design. Rename invariant: never two keys. | **Locked** |
...
| **A6 ACL write + take ownership** | SetOwner, TakeOwnership, SetSddl. | **Done** |
| **A7 Atomic rename** | `RegRenameKey` same parent. Else copy + delete + rollback dest. | **Done** |
